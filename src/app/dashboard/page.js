...
import Transition from "@/framer/_components/Transition";
      ...
      <div className="w-full p-5">
        <div className="w-full">
          ...
          <p className="text-primary font-medium">
            ...
            tackle marketing challenges. Streamline strategy development,
            optimize campaigns, and enhance audience engagement for impactful
